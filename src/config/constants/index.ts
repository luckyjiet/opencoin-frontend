...
export const ROUTER_ADDRESS = '0xc65f43792Db6a3D1b0c87A29275D2c300E7a9A44'
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  [ChainId.MAINNET]: [WETH[ChainId.MAINNET], BHV[ChainId.MAINNET], USDT[ChainId.MAINNET],    ],
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  [ChainId.MAINNET]: [[BHV[ChainId.MAINNET], WETH[ChainId.MAINNET]]],
  [ChainId.TESTNET]: [[BHV[ChainId.TESTNET], WETH[ChainId.TESTNET]]],
}
