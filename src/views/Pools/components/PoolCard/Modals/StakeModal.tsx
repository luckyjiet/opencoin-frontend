...
const StakeModal: React.FC<StakeModalProps> = ({
  ...
  const maxAmount = getFullDisplayBalance(getCalculatedStakingLimit(), stakingToken.decimals)
  useEffect(() => {
    ...
    >
      ...
      {/* {!isRemovingStake && (
        <Flex mt="24px" alignItems="center" justifyContent="space-between">
          ...
          <AnnualRoiContainer alignItems="center" onClick={() => setShowRoiCalculator(false)}>
      ...
      <Button
        ...
        disabled={!stakeAmount || parseFloat(stakeAmount) === 0 || parseFloat(stakeAmount) > parseFloat(maxAmount)}
        mt="24px"
      >
