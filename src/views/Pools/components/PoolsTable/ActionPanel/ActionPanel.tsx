  ...
  const blocksRow =
    blocksRemaining || blocksUntilStart ? (
      <Flex mb="8px" justifyContent="space-between">
        ...
        <Flex>
          <Link external href={getTrueScanLink(hasPoolStarted ? endBlock : startBlock, 'countdown')}>
    ...
    <StyledActionPanel expanded={expanded}>
      <InfoSection>
        ...
        <Flex mb="8px" justifyContent={['flex-end', 'flex-end', 'flex-start']}>
          <LinkExternal href={`https://testnet.bscscan.comaddress/${getAddress(earningToken.address)}`} bold={false}>
            {t('See Token Info')}
          </LinkExternal>
        </Flex>
        {/* <Flex mb="8px" justifyContent={['flex-end', 'flex-end', 'flex-start']}>
      ...
      <ActionContainer>
        {showSubtitle && (
          <Text mt="4px" mb="16px" color="textSubtle">
            {isAutoVault ? t('Automatic restaking') : `${t('Earn')} BHV ${t('Stake').toLocaleLowerCase()} BHV`}
          </Text>
        )}
        {pool.isAutoVault ? (
